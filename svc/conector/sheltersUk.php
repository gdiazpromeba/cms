<?php
 ...
 if ($ultimo=='seleccionaUniversal'){
  	...
  	if (isset($_REQUEST['firstArea'])) $_REQUEST['countryName']=$_REQUEST['firstArea'];
  	if (isset($_REQUEST['secondArea'])) $_REQUEST['regionName']=$_REQUEST['secondArea'];
  	$ultimo='selecciona';
 }  
...
if ($ultimo=='selecciona'){
		...
		foreach ($beans as $bean){
		  ...
		  $arrBean["urlCompleta"]= $GLOBALS["dirWeb"]  .  "/shelters/info/" . "uk" . "/" .  $arrBean["urlEncoded"];
