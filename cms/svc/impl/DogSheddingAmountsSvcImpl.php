...
require_once $_SERVER['DOCUMENT_ROOT'] . '/petzynga/oad/impl/DogSheddingAmountsOadImpl.php'; 
require_once $_SERVER['DOCUMENT_ROOT'] . '/petzynga/svc/DogSheddingAmountsSvc.php';  
