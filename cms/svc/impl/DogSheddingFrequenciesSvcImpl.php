...
require_once $_SERVER['DOCUMENT_ROOT'] . '/petzynga/oad/impl/DogSheddingFrequenciesOadImpl.php'; 
require_once $_SERVER['DOCUMENT_ROOT'] . '/petzynga/svc/DogSheddingFrequenciesSvc.php';  
