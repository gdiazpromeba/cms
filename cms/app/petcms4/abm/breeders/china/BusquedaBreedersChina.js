Ext.define('app.petcms4.abm.breeders.china.BusquedaBreedersChina', {
      extend: 'Ext.form.Panel',
      region: 'west',
      frame: true,
      items: [
        {fieldLabel: 'Name ', xtype: 'textfield', itemId: 'name', allowBlank: true, width: 230},
        {fieldLabel: 'Province ', xtype: 'comboChinaProvinces', itemId: 'comboChinaProvinces', width: 320 },
        {fieldLabel: 'Zip Code ', xtype: 'textfield', vtype: 'chinaZipCode',  itemId: 'zipCode', minLenght: 5, maxLenght: 5,  width: 200 },
      ...
      getParamsBusqueda: function(){
        ...
        this.agregaClaveValor(resultado, 'province', this.getComponent('comboChinaProvinces').getRawValue());
      ...
      reinicializar: function(){
            this.getForm().reset();
            this.getComponent('comboChinaProvinces').setValue('');
            this.getComponent('comboChinaProvinces').setRawValue('');
