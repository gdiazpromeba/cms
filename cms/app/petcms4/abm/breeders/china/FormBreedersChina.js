Ext.define('app.petcms4.abm.breeders.china.FormBreedersChina', {
    extend: 'app.petcms4.abm.PanelFormCabeceraAbm',
    requires: ['Utilities'],
    frame: true,
    prefijo: 'formBreedersChina',
    nombreElementoId: 'breederChinaId',
    urlAgregado:  Global.dirAplicacion + '/svc/conector/breedersChina.php/inserta',
    urlModificacion: Global.dirAplicacion + '/svc/conector/breedersChina.php/actualiza',
    urlBorrado: Global.dirAplicacion + '/svc/conector/breedersChina.php/borra',
    layout: 'column',
    listeners:{
    ...
    items: [
      {xtype: 'hidden', name: 'breederChinaId', itemId: 'breederChinaId'},            
      {xtype: 'fieldset', itemId: 'colIzq', id: 'colIzqFormBreedersChina', border: false, style: 'padding:0px', bodyStyle: 'padding:0px', columnWidth: 0.5,
        items:[            
      ...
      {xtype: 'fieldset', itemId: 'colDer', border: false, style: 'padding:0px', bodyStyle: 'padding:0px', columnWidth: 0.5,
    	  items:[
                                   ...
                                   store: Ext.create('Ext.data.JsonStore', {
                                	    ...
                                	    proxy: {
                                	        ...
                                	        api: {
                                	          ...
                                	          create: Global.dirAplicacion + '/svc/conector/breedersChina.php/vinculaDogBreed',
                                	          //update: Global.dirAplicacion + '/svc/conector/dogBreeds.php/actualizaEnLotePorShelter',
                                	          destroy: Global.dirAplicacion + '/svc/conector/breedersChina.php/desvinculaDogBreed',
                                	        }
                                	    },
                                	    remoteSort: false,
                                	    pageSize: 15
                                     ...
                                     store: Ext.create('Ext.data.JsonStore', {
                                  	    ...
                                  	    proxy: {
                                  	        ...
                                  	        api: {
                                  	          ...
                                  	          create: Global.dirAplicacion + '/svc/conector/breedersChina.php/vinculaCatBreed',
                                  	          //update: Global.dirAplicacion + '/svc/conector/dogBreeds.php/actualizaEnLotePorShelter',
                                  	          destroy: Global.dirAplicacion + '/svc/conector/breedersChina.php/desvinculaCatBreed',
                                  	        }
                                  	    },
                                  	    remoteSort: false,
                                  	    pageSize: 15
                    ...
                    {title: 'GeoLocation', xtype: 'fieldset', itemId: 'coordenadas', id: 'coordenadasFormBreedersChina',  border: true, collapsible: true, collapsed: true,
                    	items: [
                          ...
                          {fieldLabel: 'Longitude', xtype: 'numberfield',  name: 'longitude', itemId: 'longitude',  allowBlank: false, decimalPrecision: 8, width: 200, readOnly: true},
          	              {xtype: 'button', text: 'GeoLocation', itemId: 'botGeoLocation', 
                          	listeners:{
                        		click : function(  The, eOpts ){
                        			var coordenadas=Ext.getCmp('coordenadasFormBreedersChina');
                        			var colIzq=Ext.getCmp('colIzqFormBreedersChina');
                        			var address=null;
    	            ...
    	            {fieldLabel: 'Foto', xtype: 'button', text: 'Subir foto', itemId: 'botAceptar', ref: '../botAceptar', 
    		            listeners: {scope: this,  
    		               'click' :  function(but){
    		                 var win=muestraRemisionFotos('fichaFotoFU',  Global.dirAplicacion + '/svc/conector/breedersChina.php/subeLogo');
    		                 win.show();
    		                 win.on("beforedestroy", function(){
    		                	 var frm = but.up('form');
    		                	 var colDer = frm.getComponent('colDer');
    		                     colDer.getComponent('logoUrl').setValue(win.getNombreArchivoFoto());
    		                     colDer.getComponent('imageLogoShelter').el.dom.src= Global.dirAplicacion + '/resources/images/breederLogos/china/' + win.getNombreArchivoFoto(); 
    		                 });
    		               }//evento click
    		              }//listeners
    		         },//botón Aceptar       
    ...
    cargaRazasAsociadas : function(me, breederId){
      ...
      this.getComponent('breederChinaId').setValue(record.data['id']);
      ...
      //foto
  	  ...
  	  var urlImagen =Global.dirAplicacion + '/resources/images/breederLogos/china/' +record.get('logoUrl');
  	  try{
  ...
  pueblaFormEnRegistro : function(record){
	record.data['id']=  this.getComponent('breederChinaId').getValue();	  
	var colIzq=this.getComponent('colIzq');
