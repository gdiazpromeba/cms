...
var breedersChinaStore = Ext.create('Ext.data.JsonStore', {
    // store configs
    autoDestroy: true,
    model: 'BreedersChinaModel',
    proxy: {
        type: 'ajax',
        url: Global.dirAplicacion + '/svc/conector/breedersChina.php/selecciona',
        reader: {
            type: 'json',
            root: 'data',
            idProperty: 'id',
...
Ext.define('app.petcms4.abm.breeders.china.GrillaBreedersChina', {
	  extend: 'Ext.grid.Panel',
	  store : breedersChinaStore,
	  columns : [ 
