...
var breedersUkStore = Ext.create('Ext.data.JsonStore', {
    // store configs
    autoDestroy: true,
    model: 'BreedersUkModel',
    proxy: {
        type: 'ajax',
        url: Global.dirAplicacion + '/svc/conector/breedersUk.php/selecciona',
        reader: {
            type: 'json',
            root: 'data',
            idProperty: 'id',
...
Ext.define('app.petcms4.abm.breeders.uk.GrillaBreedersUk', {
	  extend: 'Ext.grid.Panel',
	  store : breedersUkStore,
	  columns : [ 
