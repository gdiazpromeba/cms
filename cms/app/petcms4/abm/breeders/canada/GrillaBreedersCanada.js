Ext.define('BreedersCanadaModel',{
...
var breedersCanadaStore = Ext.create('Ext.data.JsonStore', {
    // store configs
    autoDestroy: true,
    model: 'BreedersCanadaModel',
    proxy: {
        type: 'ajax',
        url: Global.dirAplicacion + '/svc/conector/breedersCanada.php/selecciona',
        reader: {
            type: 'json',
            root: 'data',
            idProperty: 'id',
...
Ext.define('app.petcms4.abm.breeders.canada.GrillaBreedersCanada', {
	  extend: 'Ext.grid.Panel',
	  store : breedersCanadaStore,
	  columns : [ 
	    ...
	    {header : 'Distance', dataIndex : 'distanceKm', width : 110,  xtype: 'numbercolumn', format:'0', align: 'right'}
	  ],
