Ext.define('app.petcms4.abm.breeders.canada.FormBreedersCanada', {
    extend: 'app.petcms4.abm.PanelFormCabeceraAbm',
    requires: ['Utilities'],
    frame: true,
    prefijo: 'formBreedersCanada',
    nombreElementoId: 'breederCanadaId',
    urlAgregado:  Global.dirAplicacion + '/svc/conector/breedersCanada.php/inserta',
    urlModificacion: Global.dirAplicacion + '/svc/conector/breedersCanada.php/actualiza',
    urlBorrado: Global.dirAplicacion + '/svc/conector/breedersCanada.php/borra',
    layout: 'column',
    listeners:{
    ...
    items: [
      {xtype: 'hidden', name: 'breederCanadaId', itemId: 'breederCanadaId'},            
      {xtype: 'fieldset', itemId: 'colIzq', id: 'colIzqFormBreedersCanada', border: false, style: 'padding:0px', bodyStyle: 'padding:0px', columnWidth: 0.5,
        items:[            
      ...
      {xtype: 'fieldset', itemId: 'colDer', border: false, style: 'padding:0px', bodyStyle: 'padding:0px', columnWidth: 0.5,
    	  items:[
                                   ...
                                   store: Ext.create('Ext.data.JsonStore', {
                                	    ...
                                	    proxy: {
                                	        ...
                                	        api: {
                                	          ...
                                	          create: Global.dirAplicacion + '/svc/conector/breedersCanada.php/vinculaDogBreed',
                                	          //update: Global.dirAplicacion + '/svc/conector/dogBreeds.php/actualizaEnLotePorShelter',
                                	          destroy: Global.dirAplicacion + '/svc/conector/breedersCanada.php/desvinculaDogBreed',
                                	        }
                                	    },
                                	    remoteSort: false,
                                	    pageSize: 15
                                     ...
                                     store: Ext.create('Ext.data.JsonStore', {
                                  	    ...
                                  	    proxy: {
                                  	        ...
                                  	        api: {
                                  	          ...
                                  	          create: Global.dirAplicacion + '/svc/conector/breedersCanada.php/vinculaCatBreed',
                                  	          //update: Global.dirAplicacion + '/svc/conector/dogBreeds.php/actualizaEnLotePorShelter',
                                  	          destroy: Global.dirAplicacion + '/svc/conector/breedersCanada.php/desvinculaCatBreed',
                                  	        }
                                  	    },
                                  	    remoteSort: false,
                                  	    pageSize: 15
                    ...
                    {title: 'GeoLocation', xtype: 'fieldset', itemId: 'coordenadas', id: 'coordenadasFormBreedersCanada',  border: true, collapsible: true, collapsed: true,
                    	items: [
                          {fieldLabel: 'Zip Code', xtype: 'textfield', vtype: 'canadaZipCode',  name: 'zip', itemId: 'zip',  allowBlank: false, width: 180},                    	        
                          {fieldLabel: 'Province', xtype: 'textfield',  name: 'adminArea1',   itemId: 'adminArea1',    readOnly: true, allowBlank: true, width: 250},
                          ...
                          {fieldLabel: 'Longitude', xtype: 'numberfield',  name: 'longitude', itemId: 'longitude',  allowBlank: false, decimalPrecision: 8, width: 200, readOnly: true},
          	              {xtype: 'button', text: 'GeoLocation', itemId: 'botGeoLocation', 
                          	listeners:{
                        		click : function(  The, eOpts ){
                        			var coordenadas=Ext.getCmp('coordenadasFormBreedersCanada');
                        			var colIzq=Ext.getCmp('colIzqFormBreedersCanada');
                        			var address=null;
                        		    ...
                        		    geocoder.geocode( request, function( results, status ) {
                        		        ...
                        		        if ( status == google.maps.GeocoderStatus.OK ) {
                    			    		...
                    			    		//if the zip didn't provide specific subdivision, make a univocal search by latitude and longitude
    	            ...
    	            {fieldLabel: 'Foto', xtype: 'button', text: 'Subir foto', itemId: 'botAceptar', ref: '../botAceptar', 
    		            listeners: {scope: this,  
    		               'click' :  function(but){
    		                 var win=muestraRemisionFotos('fichaFotoFU',  Global.dirAplicacion + '/svc/conector/breedersCanada.php/subeLogo');
    		                 win.show();
    		                 win.on("beforedestroy", function(){
    		                	 var frm = but.up('form');
    		                	 var colDer = frm.getComponent('colDer');
    		                     colDer.getComponent('logoUrl').setValue(win.getNombreArchivoFoto());
    		                     colDer.getComponent('imageLogoShelter').el.dom.src= Global.dirAplicacion + '/resources/images/breederLogos/canada/' + win.getNombreArchivoFoto(); 
    		                 });
    		               }//evento click
    		              }//listeners
    		         },//botón Aceptar       
    ...
    cargaRazasAsociadas : function(me, breederId){
      ...
      this.getComponent('breederCanadaId').setValue(record.data['id']);
      ...
      //foto
  	  ...
  	  var urlImagen =Global.dirAplicacion + '/resources/images/breederLogos/canada/' +record.get('logoUrl');
  	  try{
  ...
  pueblaFormEnRegistro : function(record){
	record.data['id']=  this.getComponent('breederCanadaId').getValue();	  
	var colIzq=this.getComponent('colIzq');
