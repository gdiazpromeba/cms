Ext.define('app.petcms4.abm.shelters.india.BusquedaSheltersIndia', {
      extend: 'Ext.form.Panel',
      region: 'west',
      frame: true,
      items: [
        {fieldLabel: 'Name ', xtype: 'textfield', itemId: 'name', allowBlank: true, width: 230},
        {fieldLabel: 'State ', xtype: 'comboIndiaStates', itemId: 'comboIndiaStates', width: 330 },
        {fieldLabel: 'Zip Code ', xtype: 'textfield', vtype: 'indiaZipCode',  itemId: 'zipCode', minLenght: 5, maxLenght: 5,  width: 200 },
      ...
      getParamsBusqueda: function(){
        ...
        this.agregaClaveValor(resultado, 'state', this.getComponent('comboIndiaStates').getRawValue());
      ...
      reinicializar: function(){
            this.getForm().reset();
            this.getComponent('comboIndiaStates').setValue('');
