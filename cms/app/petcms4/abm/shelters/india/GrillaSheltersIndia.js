...
var sheltersIndiaStore = Ext.create('Ext.data.JsonStore', {
    // store configs
    autoDestroy: true,
    model: 'SheltersIndiaModel',
    proxy: {
        type: 'ajax',
        url: Global.dirAplicacion + '/svc/conector/sheltersIndia.php/selecciona',
        reader: {
            type: 'json',
            root: 'data',
            idProperty: 'id',
...
Ext.define('app.petcms4.abm.shelters.india.GrillaSheltersIndia', {
	  extend: 'Ext.grid.Panel',
	  store : sheltersIndiaStore,
	  columns : [ 
