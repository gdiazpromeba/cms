Ext.define('app.petcms4.abm.shelters.canada.FormSheltersCanada', {
    extend: 'app.petcms4.abm.PanelFormCabeceraAbm',
    requires: ['Utilities'],
    frame: true,
    prefijo: 'formSheltersCanada',
    nombreElementoId: 'shelterCanadaId',
    urlAgregado:  Global.dirAplicacion + '/svc/conector/sheltersCanada.php/inserta',
    urlModificacion: Global.dirAplicacion + '/svc/conector/sheltersCanada.php/actualiza',
    urlBorrado: Global.dirAplicacion + '/svc/conector/sheltersCanada.php/borra',
    layout: 'column',
    items: [
      {xtype: 'hidden', name: 'shelterCanadaId', id: 'shelterCanadaId', itemId: 'shelterCanadaId'},            
      {xtype: 'fieldset', itemId: 'colIzq', id: 'colIzqFormSheltersCanada', border: false, style: 'padding:0px', bodyStyle: 'padding:0px', columnWidth: 0.5,
        items:[            
      ...
      {xtype: 'fieldset', itemId: 'colDer', border: false, style: 'padding:0px', bodyStyle: 'padding:0px', columnWidth: 0.5,
    	  items:[
                                   ...
                                   store: Ext.create('Ext.data.JsonStore', {
                                	    ...
                                	    proxy: {
                                	        ...
                                	        api: {
                                	          ...
                                	          create: Global.dirAplicacion + '/svc/conector/sheltersCanada.php/vinculaDogBreed',
                                	          //update: Global.dirAplicacion + '/svc/conector/dogBreeds.php/actualizaEnLotePorShelter',
                                	          destroy: Global.dirAplicacion + '/svc/conector/sheltersCanada.php/desvinculaDogBreed',
                                	        }
                                	    },
                                	    remoteSort: false,
                                	    pageSize: 15
                    ...
                    {title: 'GeoLocation', xtype: 'fieldset', itemId: 'coordenadas', id: 'coordenadasFormSheltersCanada',  border: true, collapsible: true, collapsed: true,
                    	items: [
                          ...
                          {fieldLabel: 'Adm.Area 2', xtype: 'textfield',  name: 'adminArea2',   itemId: 'adminArea2',    readOnly: true, allowBlank: true, width: 250},
                          ...
                          {fieldLabel: 'Longitude', xtype: 'numberfield',  name: 'longitude', itemId: 'longitude',  allowBlank: false, decimalPrecision: 8, width: 200, readOnly: true},
          	              {xtype: 'button', text: 'GeoLocation', itemId: 'botGeoLocation', 
                          	listeners:{
                        		click : function(  The, eOpts ){
                        			var coordenadas=Ext.getCmp('coordenadasFormSheltersCanada');
                        			var colIzq=Ext.getCmp('colIzqFormSheltersCanada');
                        			var address=null;
    	            ...
    	            {fieldLabel: 'Foto', xtype: 'button', text: 'Subir foto', itemId: 'botAceptar', ref: '../botAceptar', 
    		            listeners: {scope: this,  
    		               'click' :  function(but){
    		                 var win=muestraRemisionFotos('fichaFotoFU',  Global.dirAplicacion + '/svc/conector/sheltersCanada.php/subeLogo');
    		                 win.show();
    ...
    cargaRazasAsociadas : function(me, shelterId){
      ...
      this.getComponent('shelterCanadaId').setValue(record.data['id']);
      ...
      //foto
  	  ...
  	  var urlImagen =Global.dirAplicacion + '/resources/images/shelterLogos/canada/' +record.get('logoUrl');
  	  try{
  ...
  pueblaFormEnRegistro : function(record){
	record.data['id']=  this.getComponent('shelterCanadaId').getValue();	  
	var colIzq=this.getComponent('colIzq');
