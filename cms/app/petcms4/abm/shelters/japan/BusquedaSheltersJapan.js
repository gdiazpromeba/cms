Ext.define('app.petcms4.abm.shelters.japan.BusquedaSheltersJapan', {
      ...
      getParamsBusqueda: function(){
        ...
        this.agregaClaveValor(resultado, 'prefecture', this.getComponent('comboJapanPrefectures').getRawValue());
