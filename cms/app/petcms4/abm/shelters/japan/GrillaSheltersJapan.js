...
var sheltersJapanStore = Ext.create('Ext.data.JsonStore', {
    // store configs
    autoDestroy: true,
    model: 'SheltersJapanModel',
    proxy: {
        type: 'ajax',
        url: Global.dirAplicacion + '/svc/conector/sheltersJapan.php/selecciona',
        reader: {
            type: 'json',
            root: 'data',
            idProperty: 'id',
...
Ext.define('app.petcms4.abm.shelters.japan.GrillaSheltersJapan', {
	  extend: 'Ext.grid.Panel',
	  store : sheltersJapanStore,
	  columns : [ 
