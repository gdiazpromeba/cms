Ext.define('app.petcms4.abm.news.BusquedaNews', {
      ...
      getParamsBusqueda: function(){
        ...
        this.agregaClaveValor(resultado, 'newsTitle', this.getComponent('newsTitle').getValue());
        this.agregaClaveValor(resultado, 'newsContent', this.getComponent('newsContent').getValue());
