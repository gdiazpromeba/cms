...
require_once $_SERVER['DOCUMENT_ROOT'] . $GLOBALS['dirAplicacion'] . '/oad/SheltersJapanOad.php';
require_once $_SERVER['DOCUMENT_ROOT'] . $GLOBALS['dirAplicacion'] . '/beans/ShelterJapan.php';
//require_once('FirePHPCore/fb.php4'); 

   class SheltersJapanOadImpl extends AOD implements SheltersJapanOad { 
      ...
      public function obtiene($id){ 
         ...
         $sql.="  SHJ.LONGITUDE     \n";
         $sql.="FROM  \n"; 
         $sql.="  SHELTERS_JAPAN  SHJ \n"; 
         $sql.="  INNER JOIN JAPAN_ZIPS ZIU ON SHJ.ZIP_CODE=ZIU.ZIP_CODE  \n";
         $sql.="WHERE  \n"; 
         $sql.="  SHJ.ID='" . $id . "' \n"; 
      ...
      public function inserta($bean){ 
         $conexion=$this->conectarse(); 
         $sql="INSERT INTO SHELTERS_JAPAN (   \n"; 
         $sql.="  ID,     \n"; 
         $sql.="  NAME,     \n"; 
         $sql.="  ZIP_CODE,     \n"; 
         $sql.="  URL,     \n"; 
      ...
      public function borra($id){ 
         $conexion=$this->conectarse(); 
         $sql="DELETE FROM SHELTERS_JAPAN   \n"; 
         $sql.="WHERE ID=?   \n"; 
         $stm=$this->preparar($conexion, $sql);  
         $stm->bind_param("s", $id);  
      ...
      public function selTodos($nombre, $prefecture, $latitude, $longitude, $distance, $specialBreedId, $desde, $cuantos){ 
         $conexion=$this->conectarse(); 
         $sql="SELECT  \n"; 
         $sql.="  SHJ.ID,     \n"; 
         $sql.="  SHJ.NUMBER,     \n";
         ...
         if (!(empty($prefecture))){
         	$sql.="  AND ADMINISTRATIVE_AREA_LEVEL_1 ='" . $prefecture . "'  \n";
         }
         if (!(empty($distance))){
      ...
      public function selTodosCuenta($nombre, $prefecture, $latitude, $longitude, $distance, $specialBreedId){ 
         $conexion=$this->conectarse(); 
         $sql="SELECT COUNT(*) FROM SHELTERS_JAPAN SHJ "; 
         $sql.="WHERE  1=1  \n";
                   if (!(empty($nombre))){
         	$sql.="  AND SHJ.NAME LIKE '%" . $nombre . "%'  \n";
         }
