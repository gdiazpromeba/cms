...
require_once $_SERVER['DOCUMENT_ROOT'] . $GLOBALS['dirAplicacion'] . '/oad/SheltersIndiaOad.php';
require_once $_SERVER['DOCUMENT_ROOT'] . $GLOBALS['dirAplicacion'] . '/beans/ShelterIndia.php';
//require_once('FirePHPCore/fb.php4'); 

   class SheltersIndiaOadImpl extends AOD implements SheltersIndiaOad { 
      ...
      public function obtiene($id){ 
         ...
         $sql.="  SHJ.LONGITUDE     \n";
         $sql.="FROM  \n"; 
         $sql.="  SHELTERS_INDIA  SHJ \n"; 
         $sql.="  INNER JOIN INDIA_ZIPS ZIU ON SHJ.ZIP_CODE=ZIU.ZIP_CODE  \n";
         $sql.="WHERE  \n"; 
         $sql.="  SHJ.ID='" . $id . "' \n"; 
      ...
      public function inserta($bean){ 
         $conexion=$this->conectarse(); 
         $sql="INSERT INTO SHELTERS_INDIA (   \n"; 
         $sql.="  ID,     \n"; 
         $sql.="  NAME,     \n"; 
         $sql.="  ZIP_CODE,     \n"; 
         $sql.="  URL,     \n"; 
      ...
      public function borra($id){ 
         $conexion=$this->conectarse(); 
         $sql="DELETE FROM SHELTERS_INDIA   \n"; 
         $sql.="WHERE ID=?   \n"; 
         $stm=$this->preparar($conexion, $sql);  
         $stm->bind_param("s", $id);  
      ...
      public function selTodos($nombre, $stateName, $districtName, $latitude, $longitude, $distance, $specialBreedId, $desde, $cuantos){ 
         ...
         if (!(empty($stateName))){
         	$sql.="  AND ADMINISTRATIVE_AREA_LEVEL_1 ='" . $stateName . "'  \n";
         }
         if (!(empty($districtName))){
         	$sql.="  AND ADMINISTRATIVE_AREA_LEVEL_2 ='" . $districtName . "'  \n";
         }
         if (!(empty($distance))){
      ...
      public function selTodosCuenta($nombre, $stateName, $districtName, $latitude, $longitude, $distance, $specialBreedId){ 
         $conexion=$this->conectarse(); 
         $sql="SELECT COUNT(*) FROM SHELTERS_INDIA SHJ "; 
         $sql.="WHERE  1=1  \n";
         if (!(empty($nombre))){
         	$sql.="  AND SHJ.NAME LIKE '%" . $nombre . "%'  \n";
         }
