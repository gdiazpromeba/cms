...
require_once $GLOBALS['pathCms'] . '/oad/BreedersUkOad.php';
require_once $GLOBALS['pathCms'] . '/beans/BreederUk.php';
//require_once('FirePHPCore/fb.php4'); 

   class BreedersUkOadImpl extends AOD implements BreedersUkOad { 
      ...
      public function obtiene($id){ 
         ...
         $sql.="FROM  \n"; 
         $sql.="  BREEDERS_UK  SHJ \n"; 
         $sql.="  INNER JOIN UK_ZIPS ZIU ON SHJ.ZIP_CODE=ZIU.ZIP_CODE  \n";
         $sql.="WHERE  \n"; 
         $sql.="  SHJ.ID='" . $id . "' \n"; 
      ...
      public function selAAL1DeBreeders(){
            	$conexion=$this->conectarse();
      	$sql="SELECT  \n";
      	$sql.="  ADMINISTRATIVE_AREA_LEVEL_1,  \n";
      	$sql.="  COUNT(*)  \n";
